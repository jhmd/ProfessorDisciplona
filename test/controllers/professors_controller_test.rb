...
class ProfessorsControllerTest < ActionController::TestCase
  ...
  test "should create professor" do
    assert_difference('Professor.count') do
      post :create, professor: { cpf: @professor.cpf, email: @professor.email, login: @professor.login, nome: @professor.nome }
    end
  ...
  test "should update professor" do
    patch :update, id: @professor, professor: { cpf: @professor.cpf, email: @professor.email, login: @professor.login, nome: @professor.nome }
    assert_redirected_to professor_path(assigns(:professor))
  end
